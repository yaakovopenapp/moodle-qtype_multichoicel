 ...
 * needed to restore one multichoicel qtype plugin
 *
 * @copyright  2010 onwards Eloy Lafuente (stronk7) {@link http://stronk7.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_qtype_multichoicel_plugin extends restore_qtype_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff.
        $elename = 'multichoicel';
        // We used get_recommended_name() so this works.
        $elepath = $this->get_pathfor('/multichoicel');
    ...
    /**
     * Process the qtype/multichoicel element
     */
    public function process_multichoicel($data) {
        global $DB;
        ...
        if ($questioncreated) {
            ...
            if (!$DB->record_exists('qtype_multichoicel_options', array('questionid' => $data->questionid))) {
                $newitemid = $DB->insert_record('qtype_multichoicel_options', $data);
                $this->set_mapping('qtype_multichoicel_options', $oldid, $newitemid);
            }
        }
    }
     ...
     * recoded pointing to all the restored stuff for multichoicel questions
     *
    ...
    public static function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('qtype_multichoicel_options',
                $fields, 'qtype_multichoicel_options');

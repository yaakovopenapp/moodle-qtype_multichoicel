 ...
 */
function xmldb_qtype_multichoicel_upgrade($oldversion) {
    global $CFG, $DB;
    ...
    if ($oldversion < $newversion) {
        ...
        // Define field showstandardinstruction to be added to qtype_multichoicel_options.
        $table = new xmldb_table('qtype_multichoicel_options');
        ...
        // multichoicel savepoint reached.
        upgrade_plugin_savepoint(true, $newversion, 'qtype', 'multichoicel');
    }

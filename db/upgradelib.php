...
/**
 * Upgrade library code for the multichoicel question type.
 *
 * @package    qtype
...
/**
 * Class for converting attempt data for multichoicel questions when upgrading
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multichoicel_qe2_attempt_updater extends question_qtype_attempt_updater {
    protected $order;

    public function is_blank_answer($state) {
        // Blank multichoicel answers are not empty strings, they rather end in a colon.

...
$string['pluginname'] = 'Multiple choice limit';
$string['pluginname_help'] = 'In response to a question (that may include an image) the respondent chooses from multiple answers. A multiple choice limit question may have one or multiple correct answers.';
$string['pluginname_link'] = 'question/type/multichoicel';
$string['pluginnameadding'] = 'Adding a Multiple choice limit question';
$string['pluginnameediting'] = 'Editing a Multiple choice limit question';
$string['pluginnamesummary'] = 'Allows the selection of a single or multiple responses from a pre-defined list.';
$string['privacy:metadata'] = 'Multiple choice limit question type plugin allows question authors to set default options as user preferences.';
...
$string['showstandardinstruction_help'] = 'Whether to show the instructions "Select one:" or "Select one or more:" before multiple choice limit answers.';

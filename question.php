 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_multichoicel_base extends question_graded_automatically {
    ...
    public function apply_attempt_state(question_attempt_step $step) {
        ...
        foreach ($this->order as $ansid) {
            ...
            $a = new stdClass();
            $a->id = 0;
            $a->answer = html_writer::span(get_string('deletedchoice', 'qtype_multichoicel'),
                    'notifyproblem');
    ...
    public function get_question_definition_for_external_rendering(question_attempt $qa, question_display_options $options) {
        ...
        return [
            ...
            'maximumanswers' => $this->maximumanswers,
            'layout' => $this->layout,
        ];
    }
}
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multichoicel_single_question extends qtype_multichoicel_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_multichoicel', 'single');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectananswer', 'qtype_multichoicel');
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multichoicel_multi_question extends qtype_multichoicel_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_multichoicel', 'multi');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectatleastoneanswer', 'qtype_multichoicel');
    }

 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_multichoicel_renderer_base extends qtype_with_combined_feedback_renderer {
    ...
    public function formulation_and_controls(question_attempt $qa,
        ...
        $this->page->requires->js_call_amd('qtype_multichoicel/answers', 'init',
     ...
     * options returned by {@link qtype_multichoicel:;get_numbering_styles()}.
    ...
    protected function correct_choices(array $right) {
        ...
        if (count($right) == 1) {
                return get_string('correctansweris', 'qtype_multichoicel',
                        implode(', ', $right));
        } else if (count($right) > 1) {
                return get_string('correctanswersare', 'qtype_multichoicel',
                        implode(', ', $right));
        } else {
                return "";
        }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multichoicel_single_renderer extends qtype_multichoicel_renderer_base {
    ...
    protected function prompt() {
        return get_string('selectone', 'qtype_multichoicel');
    }
    ...
    public function after_choices(question_attempt $qa, question_display_options $options) {
        ...
        $clearchoicewrapperattrs = [
            ...
            'class' => 'qtype_multichoicel_clearchoice',
        ];
        ...
        $clearchoice = html_writer::link('#', get_string('clearchoice', 'qtype_multichoicel'),
        ...
        $this->page->requires->js_call_amd('qtype_multichoicel/clearchoice', 'init',
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multichoicel_multi_renderer extends qtype_multichoicel_renderer_base {
    ...
    protected function prompt() {
        return get_string('selectmulti', 'qtype_multichoicel');
    }
    ...
    protected function num_parts_correct(question_attempt $qa) {
        if ($qa->get_question()->get_num_selected_choices($qa->get_last_qt_data()) >
            ...
            return get_string('toomanyselected', 'qtype_multichoicel');
        }

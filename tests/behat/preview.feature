...
Feature: Preview a Multiple choice question
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | multichoicel | Multi-choice-001 | two_of_four |
      | Test questions   | multichoicel | Multi-choice-002 | one_of_four |
  ...
  Scenario: Preview a Multiple choice question and submit a partially correct response.
    ...
    And I click on "One" "qtype_multichoicel > Answer"
    And I click on "Two" "qtype_multichoicel > Answer"
    And I press "Check"
  ...
  Scenario: Preview a Multiple choice question and submit a correct response.
    ...
    And I press "Start again with these options"
    And I click on "One" "qtype_multichoicel > Answer"
    And I click on "Three" "qtype_multichoicel > Answer"
    And I press "Check"
    Then I should see "One is odd"

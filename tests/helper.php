 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multichoicel_test_helper extends question_test_helper {
     ...
     * @return object
     */
    public static function get_multichoicel_question_data_two_of_four() {
        global $USER;
     ...
     * @return object
     */
    public static function get_multichoicel_question_form_data_two_of_four() {
        $qdata = new stdClass();
     ...
     * @return object
     */
    public static function get_multichoicel_question_data_one_of_four() {
        global $USER;
     ...
     * @return object
     */
    public static function get_multichoicel_question_form_data_one_of_four() {
        $qdata = new stdClass();

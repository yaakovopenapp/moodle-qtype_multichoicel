...
use qtype_multichoicel_multi_question;
use question_answer;
...
class question_single_test extends \advanced_testcase {
    ...
    public function test_get_expected_data() {
        $question = \test_question_maker::make_a_multichoicel_single_question();
    ...
    public function test_grading_rounding_three_right() {
        question_bank::load_question_definition_classes('multichoicel');
        $mc = new qtype_multichoicel_multi_question();
        ...
        $mc->qtype = question_bank::get_qtype('multichoicel');
    ...
    public function test_summarise_response() {
        ...
        $this->assertNull($mc->summarise_response(array(), \test_question_maker::get_a_qa($mc)));
        $this->assertNull($mc->summarise_response(array('answer' => '-1'), \test_question_maker::get_a_qa($mc)));
    }

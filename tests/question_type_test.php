...
use qtype_multichoicel;
use qtype_multichoicel_edit_form;
...
require_once($CFG->dirroot . '/question/type/multichoicel/questiontype.php');
require_once($CFG->dirroot . '/question/type/edit_question_form.php');
require_once($CFG->dirroot . '/question/type/multichoicel/edit_multichoicel_form.php');
...
class question_type_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        $this->qtype = new qtype_multichoicel();
    }
    ...
    public function test_name() {
        $this->assertEquals($this->qtype->name(), 'multichoicel');
    }
    ...
    public function test_question_saving_two_of_four($which) {
        ...
        $questiondata = \test_question_maker::get_question_data('multichoicel', $which);
        $formdata = \test_question_maker::get_question_form_data('multichoicel', $which);

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_multichoicel_edit_form::mock_submit((array)$formdata);

        $form = \qtype_multichoicel_test_helper::get_question_editing_form($cat, $questiondata);
    ...
    public function test_get_question_options() {
        ...
        $questiondata = \test_question_maker::get_question_data('multichoicel', 'two_of_four');
        $formdata = \test_question_maker::get_question_form_data('multichoicel', 'two_of_four');
        ...
        $DB->delete_records('qtype_multichoicel_options', ['questionid' => $question->id]);
        ...
        $this->assertEquals(get_config('qtype_multichoicel', 'answerhowmany'), $options->single);

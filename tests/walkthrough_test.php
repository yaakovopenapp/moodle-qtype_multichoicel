 ...
 *
 * Note, there are already lots of tests of the multichoicel type in the behaviour
 * tests. (Search for \test_question_maker::make_a_multichoicel.) This file only
...
class walkthrough_test extends \qbehaviour_walkthrough_test_base {
    public function test_deferredfeedback_feedback_multichoicel_single() {

        // Create a multichoicel, single question.
        $mc = \test_question_maker::make_a_multichoicel_single_question();
    ...
    public function test_deferredfeedback_feedback_multichoicel_single_showstandardunstruction_yes() {
        ...
        $standardinstruction = get_string('selectone', 'qtype_multichoicel');
        $this->assertStringContainsString($standardinstruction, $this->currentoutput);
    }

    public function test_deferredfeedback_feedback_multichoicel_single_showstandardunstruction_no() {
        ...
        // Check for 'Show standard instruction'.
        $standardinstruction = get_string('selectmulti', 'qtype_multichoicel');
        $this->assertStringNotContainsString($standardinstruction, $this->currentoutput);
    }

    public function test_deferredfeedback_feedback_multichoicel_multi() {
        // Create a multichoicel, multi question.
        $mc = \test_question_maker::make_a_multichoicel_multi_question();
        $mc->shuffleanswers = false;
     ...
     */
    public function test_deferredfeedback_feedback_multichoicel_clearchoice() {
    ...
    public function test_deferredfeedback_feedback_multichoicel_multi_showstandardunstruction_yes() {
    ...
    public function test_deferredfeedback_feedback_multichoicel_multi_showstandardunstruction_no() {
